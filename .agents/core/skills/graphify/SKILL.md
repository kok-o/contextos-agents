...
name: graphify
description: >
  Transforms entire codebases into structured knowledge graphs via Tree-sitter AST parsing.
  Eliminates context window burn, enables precise dependency mapping, and identifies architectural god nodes.
---
